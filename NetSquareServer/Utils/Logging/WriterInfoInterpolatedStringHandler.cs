...
{
    /// <summary>
    /// Builds an interpolated information message only when at least one destination accepts it.
    /// </summary>
    [InterpolatedStringHandler]
    public ref struct WriterInfoInterpolatedStringHandler
    {
        ...
        /// </summary>
        public WriterInfoInterpolatedStringHandler(int literalLength, int formattedCount, out bool shouldAppend)
        ...
        /// </summary>
        public WriterInfoInterpolatedStringHandler(int literalLength, int formattedCount, WriterCategory category, out bool shouldAppend)
        {
            // Literal and formatted counts remain compiler metadata because storage is preallocated.
            writerBuffer = new WriterInterpolatedBuffer(category, NetSquareLogLevel.Information, out shouldAppend);
        }
