...
{
    /// <summary>
    /// Builds an interpolated warning message only when at least one destination accepts it.
    /// </summary>
    [InterpolatedStringHandler]
    public ref struct WriterWarningInterpolatedStringHandler
    {
        ...
        /// </summary>
        public WriterWarningInterpolatedStringHandler(int literalLength, int formattedCount, out bool shouldAppend)
        ...
        /// </summary>
        public WriterWarningInterpolatedStringHandler(int literalLength, int formattedCount, WriterCategory category, out bool shouldAppend)
        {
            // Literal and formatted counts remain compiler metadata because storage is preallocated.
            writerBuffer = new WriterInterpolatedBuffer(category, NetSquareLogLevel.Warning, out shouldAppend);
        }
