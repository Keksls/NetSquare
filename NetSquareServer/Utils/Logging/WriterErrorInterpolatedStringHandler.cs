...
{
    /// <summary>
    /// Builds an interpolated error message only when at least one destination accepts it.
    /// </summary>
    [InterpolatedStringHandler]
    public ref struct WriterErrorInterpolatedStringHandler
    {
        ...
        /// </summary>
        public WriterErrorInterpolatedStringHandler(int literalLength, int formattedCount, out bool shouldAppend)
        ...
        /// </summary>
        public WriterErrorInterpolatedStringHandler(int literalLength, int formattedCount, WriterCategory category, out bool shouldAppend)
        {
            // Literal and formatted counts remain compiler metadata because storage is preallocated.
            writerBuffer = new WriterInterpolatedBuffer(category, NetSquareLogLevel.Error, out shouldAppend);
        }
