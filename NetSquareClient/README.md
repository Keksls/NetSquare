...
The package includes `NetSquareClient.dll` plus `NetSquareCore.dll` for `net48`, `netstandard2.0`, `net8.0`, and `net10.0`. Use `netstandard2.0` for broad Unity/library compatibility, and use `net8.0` or `net10.0` for modern standalone C# applications.
